    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Xoá</a></li>
            </ol>
        </div>
        <!-- row -->
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Bạn có muốn xoá: <?php echo getLocationName($_GET["id"]);?></h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="/admin/loc.php?act=storeDelete" method="post">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Bạn có chắc: </label>
                                    <div class="col-sm-9">
